class AsciinemaRC3 < Formula
  ...
  def install
    ...
    # Manually copy the binary to the bin directory
    bin.install "target/release/asciinema"    
  end

  test do
    ENV["LC_ALL"] = "en_US.UTF-8"
    output = shell_output("#{bin}/asciinema --version 2>&1")
